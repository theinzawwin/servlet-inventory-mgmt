...
function handleSelectChange(selectElement) {
    ...
    fetch('ProductSaleJsonServlet?categoryId=' + encodeURIComponent(selectedValue))
    ...
    .then(data => {
        ...
        data.forEach(product => {
            ...
            option.text = product.productName+"( Qty="+ product.qty+")";
...
function saleItemChange(e){
	console.log("sale item List",productItemList);
	var productId = e.value;
	
	const result = productItemList.find(product => product.productId == productId);
	console.log("Selected Product Id",result);
...
<div>
	...
	<table>
		...
		<tr>
			<td>Item</td>
			<td>
				<select name="productId" id="productId" onchange="saleItemChange(this)">
		...
		<tr>
			<td>Price</td>
			<td><input type="number" name="price" id="price" readonly /></td>
		</tr>
		<tr>
			<td>Qty</td>
